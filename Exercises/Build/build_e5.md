...
### Container runtime engines will locally store what are called "images" once you have "fetched" them (remembering the ___docker pull___ exercise from before, when an image file was pulled down) and these are "packages" of manifests and compressed files that all make up what is "mounted" by the container runtime. 
